...
def criar():
    ...
    novo_jogo = Jogos(nome=nome.title(), categoria=categoria.title(), console=console.upper())
...
def editar(id):
    ...
    return render_template('editar.html', titulo='Editar jogo', jogo=jogo, capa_jogo=capa_jogo, form=form)
